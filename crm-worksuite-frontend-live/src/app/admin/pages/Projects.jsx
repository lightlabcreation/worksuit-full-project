...
const Projects = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      // Ensure selected employee is included in members (if not already selected)
      const employeeId = parseInt(formData.projectManager)
      const projectMembers = [...new Set([employeeId, ...formData.projectMembers])]
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFormData({
          ...
          projectManager: fullProject.project_manager_id || '',
          ...
          projectMembers: fullProject.members?.map(m => m.id || m.user_id) || project.members?.map(m => m.id) || [],
          createPublicProject: fullProject.create_public_project || false,
  ...
  const columns = [
    ...
    },
    {
      key: 'id',
      label: 'ID',
      render: (value, row) => <span className="font-semibold text-primary-text">{row.id}</span>,
    },
    {
      key: 'name',
      label: 'Title',
      render: (value, row) => (
        <div className="flex flex-col gap-1">
          ...
          {row.label && (
            <span
              className="inline-flex items-center px-3 py-1 rounded-full text-[11px] font-bold text-white w-fit shadow-sm uppercase tracking-wider"
    ...
    },
    {
      ...
      label: 'Client',
      render: (value, row) => (
        <span className="text-primary-text">{row.client?.name || row.client_name || '-'}</span>
      ),
    },
    {
      key: 'budget',
      ...
      render: (value, row) => (
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-2 text-primary-accent hover:bg-gray-800 hover:text-white rounded transition-colors"
            title="View"
            type="button"
          >
            <IoEye size={18} />
          ...
          <button
            ...
            className="p-2 text-blue-600 hover:bg-gray-800 hover:text-white rounded transition-colors"
            title="Edit"
            type="button"
          >
            <IoCreate size={18} />
          ...
          <button
            ...
            className="p-2 text-red-600 hover:bg-gray-800 hover:text-white rounded transition-colors"
            title="Delete"
            type="button"
          >
            <IoTrash size={18} />
      ...
      >
        <div className="space-y-0 max-h-[calc(100vh-150px)] overflow-y-auto pb-4">
          <FormSection title="Project Details">
            ...
            <FormRow label="Short Code">
              <FormInput
                ...
                placeholder="Auto-generated if empty (e.g., PRJ001)"
              />
            </FormRow>
            ...
            <FormRow label="Client" required>
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={() => navigate('/app/admin/clients')} title="Add New Client" className="px-3">
                  <IoAdd size={18} />
                </Button>
              </div>
            </FormRow>
            ...
            <FormRow label="Label">
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={handleManageLabels} title="Manage Labels" className="px-3">
                  <IoPricetag size={18} />
                </Button>
              </div>
            </FormRow>
          ...
          <FormSection title="Team Assignment">
            <FormRow label="Project Manager" required>
              <FormSelect
            ...
            <FormRow label="Team Members">
              <div className="space-y-2">
                <div className="relative">
                  ...
                  />
                  <IoSearch className="absolute right-3 top-1/2 transform -translate-y-1/2 text-secondary-text" size={18} />
                </div>
                  ...
                  {filteredEmployees
                    ...
                    .map(employee => {
                      ...
                      return (
                        <label
                          key={employeeId}
                          className={`flex items-center gap-3 p-2 rounded-lg cursor-pointer hover:bg-white transition-colors ${isSelected || isManager ? 'bg-white border border-primary-accent' : ''}`}
                        >
                          <input
                            type="checkbox"
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              {isManager && (
                                <Badge variant="info" className="text-xs">Manager</Badge>
                              )}
                            </div>
                          </div>
                        </label>
          ...
          <FormSection title="Project Summary & Notes" last>
