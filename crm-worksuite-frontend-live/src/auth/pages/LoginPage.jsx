  ...
  return (
    <Card className="w-full max-w-md mx-auto relative">
          ...
          return (
            <button
              ...
              className={`p-3 md:p-4 rounded-xl border-2 transition-all duration-200 transform hover:scale-105 hover:-translate-y-1 ${isSelected
                  ? 'border-primary-accent bg-primary-accent bg-opacity-10 shadow-lg'
            ...
            >
              ...
              >
                <Icon
                  size={20}
                  className={isSelected ? 'text-primary-accent' : 'text-secondary-text'}
                />
              </div>
              <p
                className={`text-xs md:text-sm font-semibold ${isSelected ? 'text-primary-accent' : 'text-primary-text'
                  }`}
              >
                {roleCard.label}
              </p>
              <p className="text-[10px] md:text-xs text-muted-text mt-0.5 hidden md:block">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
        ...
        {role && !error && (
          <div className="bg-primary-accent bg-opacity-10 border border-primary-accent rounded-lg p-3 text-sm text-primary-accent">
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 text-center">
        <div className="flex justify-center gap-4 text-xs text-secondary-text">
          <Link to="/privacy-policy" className="hover:text-primary-accent transition-colors">
            Privacy Policy
          </Link>
          <span>•</span>
          <Link to="/terms" className="hover:text-primary-accent transition-colors">
            Terms of Service
          </Link>
        </div>
      </div>
